...
from PyQt5.QtWidgets import QDialog, QMessageBox, QLabel, QWidget
import cv2
import face_recognition
import numpy as np
import datetime
import os
from mongoPush import insert


class Ui_OutputDialog(QDialog, QLabel, QWidget):
    def __init__(self):
    ...
    def face_rec_(self, frame, encode_list_known, class_names):
        ...
        def mark_attendance(name):
            ...
            if self.ClockInButton.isChecked():
                ...
                if (name != 'unknown'):
                    buttonReply = QMessageBox.question(self, 'Welcome, ' + name, 'Are you Checking In?',
                    ...
                    if buttonReply == QMessageBox.Yes:
                        ...
                        insert(
                            name=str(name[:-3]), number=number, date=date, time=dtString)
